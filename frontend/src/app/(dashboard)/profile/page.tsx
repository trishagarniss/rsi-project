  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="relative z-10">
        {successMsg && (
          <div className="p-4 bg-green-50 border-2 border-green-200 text-green-700 rounded-2xl flex items-center gap-3 text-sm font-bold mb-6">
            <CheckCircle size={20} className="shrink-0 text-green-500" />
            <span>{successMsg}</span>
          </div>
        )}
        {errorMsg && (
          <div className="p-4 bg-red-50 border-2 border-red-200 text-red-700 rounded-2xl flex items-start gap-3 text-sm font-bold mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Ganti Password */}
            <button onClick={() => { setShowPasswordModal(true); router.replace("/profile?modal=password", undefined); }} className="w-full bg-white rounded-[24px] border-2 border-slate-200 hover:border-asgard-secondary hover:-translate-y-0.5 transition-all duration-300 p-5 flex items-center gap-4 group text-left cursor-pointer">
            ...
            {/* Keamanan Sesi */}
            <button onClick={() => { setShowSessionModal(true); router.replace("/profile?modal=session", undefined); }} className="w-full bg-white rounded-[24px] border-2 border-slate-200 hover:border-asgard-secondary hover:-translate-y-0.5 transition-all duration-300 p-5 flex items-center gap-4 group text-left cursor-pointer">
