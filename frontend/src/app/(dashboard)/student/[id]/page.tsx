...
export default function StudentDetail() {
      ...
      try {
        ...
        const [studentResult, academicsResult, attendancesResult, socioEconomicResult, predictionResult] =
          await Promise.allSettled([
            ...
            fetchAcademics(studentId),
            fetchAttendances(studentId),
            fetchSocioEconomic(studentId),
  ...
  const riskLevel = latestPrediction ? formatRiskLabel(latestPrediction.risk_score, latestPrediction.is_at_risk) : 'Aman';
                  ...
                  <div className="space-y-4">
                    <div className="p-6 rounded-xl border border-amber-200 bg-amber-50">
                      ...
                      <p className="text-sm text-amber-900 font-medium leading-relaxed">
                        {latestPrediction.factors_summary ?? 'Backend belum menyimpan ringkasan faktor risiko untuk prediksi ini.'}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="p-4 rounded-xl border border-slate-100 bg-slate-50">
                        ...
                        <p className="text-base font-black text-slate-700 mt-1">{latestPrediction.is_at_risk ? 'Berisiko' : 'Aman'}</p>
                      </div>
                      <div className="p-4 rounded-xl border border-slate-100 bg-slate-50">
