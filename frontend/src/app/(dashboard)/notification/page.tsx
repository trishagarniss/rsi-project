    ...
    <div className="max-w-5xl space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="border-slate-200">Pengaturan Notifikasi</Button>
          <Button variant="primary" className="shadow-md">Tandai Semua Dibaca</Button>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {visibleLogs.map((notif) => (
          <div key={notif.id} className={'p-6 rounded-2xl border transition-all duration-300 flex flex-col sm:flex-row gap-5 ' + (notif.tipe === 'Kritis' ? 'bg-red-50 border-red-100 shadow-sm hover:shadow-md' : notif.tipe === 'Peringatan' ? 'bg-amber-50 border-amber-100 shadow-sm hover:shadow-md' : 'bg-white border-slate-100 shadow-sm hover:shadow-md')}>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                ...
                <span className="text-xs font-bold text-slate-400 whitespace-nowrap">{notif.waktu}</span>
              </div>
