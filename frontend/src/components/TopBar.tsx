...
export default function TopBar() {
  ...
  // Breadcrumb dinamis berdasarkan URL
  const getBreadcrumb = () => {
    if (pathname.includes('/student')) return 'Dashboard / Daftar Siswa';
    if (pathname.includes('/counseling')) return 'Dashboard / Manajemen Konseling';
    if (pathname.includes('/reports')) return 'Dashboard / Laporan';
    if (pathname.includes('/import')) return 'Dashboard / Import Data';
    if (pathname.includes('/manage-accounts')) return 'Dashboard / Manajemen Akun';
    if (pathname.includes('/settings')) return 'Dashboard / Pengaturan';
